...
var DefaultMenu = []*model.Menu{
	...
	model.NewMenu("login-policy-bind-user", "绑定用户", "login-policy-detail",
		...
		model.NewPermission("GET", "/login-policies/:id/users/id"),
		model.NewPermission("POST", "/login-policies/:id/bind"),
		model.NewPermission("POST", "/login-policies/:id/unbind"),
	),
	model.NewMenu("login-policy-bind-user-group", "绑定用户组", "login-policy-detail",
		model.NewPermission("GET", "/login-policies/:id/user-groups/paging"),
		model.NewPermission("GET", "/login-policies/:id/user-groups/id"),
		model.NewPermission("POST", "/login-policies/:id/bind-user-group"),
		model.NewPermission("POST", "/login-policies/:id/unbind-user-group"),
	),
	...
	model.NewMenu("user-bind-login-policy", "绑定策略", "user-login-policy",
		model.NewPermission("GET", "/login-policies/:id/users/id"),
		model.NewPermission("POST", "/login-policies/:id/bind"),
		model.NewPermission("POST", "/login-policies/:id/unbind"),
	),
